                        ...
                        <?php if($headerMenus->count() == 0): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu fade-down">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(route('public.instagram')); ?>">GALERI</a></li>
...
<!-- popup search end -->
<?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/components/landing/header.blade.php ENDPATH**/ ?>