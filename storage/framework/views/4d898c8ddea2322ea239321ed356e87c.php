        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header-content text-center">
                    ...
                    <p class="page-desc"><?php echo e($page->excerpt ?: 'Informasi lengkap dari halaman ini'); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="page-back mb-4">
                    <a href="<?php echo e(route('pages.public.index')); ?>" class="btn btn-outline-primary">
                ...
                <article class="page-article">
                    ...
                    <div class="page-featured-img mb-4">
                        <img src="<?php echo e(Storage::url($page->featured_image)); ?>" alt="<?php echo e($page->title); ?>" class="img-fluid rounded">
                    </div>
                    <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="page-share text-md-end">
                                    ...
                                    <div class="share-buttons">
                                        ...
                                        <button onclick="copyToClipboard('<?php echo e(request()->url()); ?>')" class="share-btn copy">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="custom-field-item">
                                        ...
                                        <p class="custom-field-value"><?php echo e($value); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="related-page-img">
                                    <?php if($relatedPage->featured_image): ?>
                                        <img src="<?php echo e(Storage::url($relatedPage->featured_image)); ?>" 
                                             alt="<?php echo e($relatedPage->title); ?>" class="img-fluid">
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/pages/public/show.blade.php ENDPATH**/ ?>