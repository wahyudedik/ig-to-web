                    ...
                    <?php if(Auth::check() && Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin', 'sarpras'])): ?>
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <div class="py-2">
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('guru.view') || Auth::user()->can('guru.read'))): ?>
                                        <a href="<?php echo e(route('admin.guru.index')); ?>"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                                            <i class="fas fa-chalkboard-teacher mr-2"></i>Guru Management
                                        </a>
                                    <?php endif; ?>
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('siswa.view') || Auth::user()->can('siswa.read'))): ?>
                                        <a href="<?php echo e(route('admin.siswa.index')); ?>"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                                            <i class="fas fa-user-graduate mr-2"></i>Siswa Management
                                        </a>
                                    <?php endif; ?>
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('jadwal.read') || Auth::user()->can('jadwal.view'))): ?>
                                        <a href="<?php echo e(route('admin.jadwal-pelajaran.index')); ?>"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                                            <i class="fas fa-calendar-alt mr-2"></i>Jadwal Pelajaran
                                        </a>
                                    <?php endif; ?>
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['sarpras', 'admin', 'superadmin']) || Auth::user()->can('sarpras.view') || Auth::user()->can('sarpras.read'))): ?>
                    ...
                    <?php if(Auth::check() && Auth::user()->hasAnyRole(['admin', 'superadmin', 'guru', 'osis'])): ?>
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <div class="py-2">
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['admin', 'superadmin', 'osis']) || Auth::user()->can('osis.read') || Auth::user()->can('osis.view'))): ?>
