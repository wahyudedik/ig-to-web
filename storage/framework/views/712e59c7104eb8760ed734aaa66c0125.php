    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have been invited to join <strong>Portal Sekolah</strong> as a <span
                    class="role-badge"><?php echo e(ucfirst($user->user_type)); ?></span>.</p>
            ...
            <div class="credentials">
                ...
                <div class="credential-item">
                    ...
                    <span class="credential-value"><?php echo e(ucfirst($user->user_type)); ?></span>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <p>© <?php echo e(date('Y')); ?> Portal Sekolah. All rights reserved.</p>
...
<?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/emails/user-invitation.blade.php ENDPATH**/ ?>