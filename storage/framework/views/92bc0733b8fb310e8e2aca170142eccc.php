...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="user_type" name="user_type" required
                            class="form-input <?php $__errorArgs = ['user_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="guru" <?php echo e(old('user_type') === 'guru' ? 'selected' : ''); ?>>Guru</option>
                            <option value="siswa" <?php echo e(old('user_type') === 'siswa' ? 'selected' : ''); ?>>Siswa</option>
                            <option value="sarpras" <?php echo e(old('user_type') === 'sarpras' ? 'selected' : ''); ?>>Sarpras
                            </option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        <a href="<?php echo e(route('admin.superadmin.users')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php endif; ?>
<?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/superadmin/users/create.blade.php ENDPATH**/ ?>