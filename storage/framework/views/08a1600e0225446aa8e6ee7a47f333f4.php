                            ...
                            <div class="pagination-info-enhanced">
                                <div class="pagination-stats">
                                    ...
                                    <span class="stat-item">
                                        ...
                                        <strong><?php echo e($pages->firstItem() ?? 0); ?></strong> -
                                        <strong><?php echo e($pages->lastItem() ?? 0); ?></strong>
                                    </span>
                                    <span class="stat-divider">•</span>
                                    <span class="stat-item">
                                        <i class="fas fa-book-open"></i>
                                        Halaman <strong><?php echo e($pages->currentPage()); ?></strong> dari
                                        <strong><?php echo e($pages->lastPage()); ?></strong>
                                    </span>
                                </div>

                                <?php if($pages->hasPages() && $pages->lastPage() > 5): ?>
                                    <!-- Quick Jump -->
                                    <div class="quick-jump mt-3">
                                        <form method="GET" action="<?php echo e(route('pages.public.index')); ?>"
