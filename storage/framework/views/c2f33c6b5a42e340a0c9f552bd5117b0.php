                                ...
                                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($page->user->name ?? 'Unknown'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-2">
                                                <a href="<?php echo e(route('pages.public.show', $page->slug)); ?>" target="_blank"
                                                ...
                                                <form action="<?php echo e(route('admin.pages.destroy', $page)); ?>" method="POST"
                                                    class="inline">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/pages/admin.blade.php ENDPATH**/ ?>