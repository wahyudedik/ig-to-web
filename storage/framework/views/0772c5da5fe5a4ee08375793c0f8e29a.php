    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span
                            class="text-xl font-bold text-slate-900"><?php echo e($analytics['user_activity']['invited_users_this_week']); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-slate-600">Invited Users This Month</span>
                        <span
                            class="text-xl font-bold text-slate-900"><?php echo e($analytics['user_activity']['invited_users_this_month']); ?></span>
                    </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 mb-8">
            ...
            <div class="h-64 flex items-end justify-between space-x-2">
                ...
                ?>
                <?php $__currentLoopData = $analytics['trends']['user_invitations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex-1 flex flex-col items-center group relative">
                        ...
                        <div
                            ...
                            <?php echo e($day['date']); ?>: <?php echo e($day['count']); ?> invited users
                        </div>
                        <!-- Bar -->
