                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4">
                                                <div>
                                                    <div class="text-sm font-medium text-gray-900"><?php echo e($link->title); ?></div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('admin.testimonial-links.toggle-active', $link)); ?>" class="inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" 
                                                            ...
                                                            <i class="fas fa-<?php echo e($link->is_active ? 'pause' : 'play'); ?>"></i>
                                                        </button>
                                                    </form>

                                                    <!-- Delete Button -->
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('testimonial-links.delete')): ?>
                                                    <form method="POST" action="<?php echo e(route('admin.testimonial-links.destroy', $link)); ?>" class="inline"
