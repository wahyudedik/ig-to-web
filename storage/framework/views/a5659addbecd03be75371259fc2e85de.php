...
<head>
    ...
    <meta name="description"
        content="<?php echo e(cache('site_setting_site_description', 'Kegiatan Sekolah - Galeri Kegiatan Terbaru')); ?>">
    <meta name="keywords"
        content="<?php echo e(cache('site_setting_site_keywords', 'kegiatan, sekolah, galeri, instagram, aktivitas')); ?>">

    <!-- title -->
    <title>E-Galeri - <?php echo e(cache('site_setting_site_name', 'Website Sekolah - Portal Digital Pendidikan')); ?></title>
                            ...
                            <ul>
                                <li>
                                    <a href="#" target="_blank"><i class="far fa-location-dot"></i>
                                        <?php echo e(cache('site_setting_contact_address', 'Jl. Pendidikan No. 123, Jakarta')); ?></a>
                                </li>
                                <li>
                                    <a href="mailto:<?php echo e(cache('site_setting_contact_email', 'info@sekolahdigital.com')); ?>"
                                        target="_blank"><i class="far fa-envelopes"></i>
                                        <?php echo e(cache('site_setting_contact_email', 'info@sekolahdigital.com')); ?></a>
                                </li>
                                <li>
                                    <a href="tel:<?php echo e(str_replace([' ', '-', '(', ')'], '', cache('site_setting_contact_phone', '+62123456789'))); ?>"
                                        target="_blank"><i class="far fa-phone-volume"></i>
                                        <?php echo e(cache('site_setting_contact_phone', '+62 123 456 789')); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container position-relative">
                    <a class="navbar-brand" href="/">
                        <?php if(cache('site_setting_logo')): ?>
                            <img src="<?php echo e(Storage::url(cache('site_setting_logo'))); ?>" alt="logo">
                        <?php else: ?>
                            ...
                            <?php if($headerMenus->count() == 0): ?>
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu fade-down">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.siswa.index')); ?>">DATA
                                                SISWA</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu fade-down">
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.guru.index')); ?>">TENAGA
                                                PENDIDIK</a></li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo e(route('pages.public.index')); ?>">KURIKULUM</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo e(route('public.kegiatan')); ?>">KEGIATAN</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-widget-box about-us">
                            <a href="/" class="footer-logo">
                                <?php if(cache('site_setting_logo')): ?>
                                    <img src="<?php echo e(Storage::url(cache('site_setting_logo'))); ?>" alt="">
                                <?php else: ?>
                            ...
                            <ul class="footer-contact">
                                <li><a
                                        href="tel:<?php echo e(str_replace([' ', '-', '(', ')'], '', cache('site_setting_contact_phone', '+62123456789'))); ?>"><i
                                            class="fab fa-whatsapp"></i><?php echo e(cache('site_setting_contact_phone', '+62 123 456 789')); ?></a>
                                </li>
                                <li><i
                                        class="far fa-map-marker-alt"></i><?php echo e(cache('site_setting_contact_address', 'Jl. Pendidikan No. 123, Jakarta')); ?>

                                </li>
                                <li><a
                                        href="mailto:<?php echo e(cache('site_setting_contact_email', 'info@sekolahdigital.com')); ?>"><i
                                            class="far fa-envelope"></i><?php echo e(cache('site_setting_contact_email', 'info@sekolahdigital.com')); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget-box list">
                            ...
                            <ul class="footer-list">
                                <li><a href="<?php echo e(route('pages.public.index')); ?>"><i class="fas fa-caret-right"></i>
                                        Halaman</a></li>
                                <li><a href="<?php echo e(route('admin.guru.index')); ?>"><i class="fas fa-caret-right"></i>
                                        Tenaga
                                        Pendidik</a></li>
                                <li><a href="<?php echo e(route('admin.siswa.index')); ?>"><i class="fas fa-caret-right"></i>
                                        Data
                                        Siswa</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="footer-widget-box list">
                            ...
                            <div class="footer-newsletter">
                                ...
                                <div class="subscribe-form">
                                    <form action="<?php echo e(route('public.instagram')); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <p class="copyright-text">
                                <?php echo e(cache('site_setting_footer_text', '&copy; Copyright <span id="date"></span> <a href="#">Website Sekolah</a> All Rights Reserved.')); ?>
...
<?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/instagram/activities.blade.php ENDPATH**/ ?>