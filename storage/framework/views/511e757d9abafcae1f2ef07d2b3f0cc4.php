                    ...
                    <form method="GET" class="flex flex-wrap gap-4">
                        ...
                        <div>
                            ...
                            <select name="position" id="position" class="rounded-md border-gray-300">
                                <option value="">All</option>
                                <option value="Siswa" <?php echo e(request('position') == 'Siswa' ? 'selected' : ''); ?>>Siswa
                                </option>
                                <option value="Guru" <?php echo e(request('position') == 'Guru' ? 'selected' : ''); ?>>Guru
                                </option>
                                <option value="Alumni" <?php echo e(request('position') == 'Alumni' ? 'selected' : ''); ?>>Alumni
                                </option>
                            </select>
                        </div>
                        <div>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="text-sm text-gray-500">
                            Showing <?php echo e($testimonials->firstItem()); ?> to <?php echo e($testimonials->lastItem()); ?> of
                            <?php echo e($testimonials->total()); ?> results
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/admin/testimonials/index.blade.php ENDPATH**/ ?>