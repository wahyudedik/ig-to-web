...
<head>
    ...
    <title>Testimonial - <?php echo e($link->title); ?></title>
    ...
    <div class="min-h-screen py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($link->title); ?></h1>
                <?php if($link->description): ?>
                    <p class="text-gray-600"><?php echo e($link->description); ?></p>
                <?php endif; ?>
            ...
            <div class="bg-white shadow-sm rounded-lg">
                <div class="p-6">
                    <form action="<?php echo e(route('testimonials.public.store', $link->token)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-6">
                                ...
                                <select name="position" id="position" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $link->target_audience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($audience); ?>" <?php echo e(old('position') == $audience ? 'selected' : ''); ?>>
                                            <?php echo e($audience); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="class-field" class="mt-6 hidden">
                                ...
                                <input type="text" name="class" id="class" value="<?php echo e(old('class')); ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="graduation-year-field" class="mt-6 hidden">
                                ...
                                <input type="text" name="graduation_year" id="graduation_year" value="<?php echo e(old('graduation_year')); ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['graduation_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="testimonial" id="testimonial" rows="6" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['testimonial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Share your experience and thoughts about the school..."><?php echo e(old('testimonial')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center space-x-2">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <input type="radio" name="rating" id="rating<?php echo e($i); ?>" value="<?php echo e($i); ?>" 
                                            <?php echo e(old('rating') == $i ? 'checked' : ''); ?> required
                                            class="h-4 w-4 text-yellow-400 focus:ring-yellow-400 border-gray-300">
                                        <label for="rating<?php echo e($i); ?>" class="text-yellow-400 cursor-pointer">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="file" name="photo" id="photo" accept="image/*"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
</html><?php /**PATH E:\PROJEK  LARAVEL\ig-to-web\resources\views/testimonials/create.blade.php ENDPATH**/ ?>