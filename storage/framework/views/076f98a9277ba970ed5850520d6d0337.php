...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Kategori Sarpras</h1>
            ...
            <form method="GET" action="<?php echo e(route('admin.sarpras.kategori.index')); ?>"
                ...
                <div class="flex gap-2">
                    <select name="status" class="form-input">
                        ...
                        <option value="inactive" <?php echo e(request('status') == 'inactive' ? 'selected' : ''); ?>>Tidak Aktif
                        </option>
                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        ...
                                        <?php echo e($k->barang_count ?? 0); ?> barang
                                    </span>
                                </td>
                                <td>
                                    <?php if($k->is_active): ?>
                                ...
                                <td>
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form method="POST"
                                            ...
                                            data-confirm="Apakah Anda yakin ingin menghapus kategori <?php echo e($k->nama_kategori); ?>?">
                                            <?php echo csrf_field(); ?>
