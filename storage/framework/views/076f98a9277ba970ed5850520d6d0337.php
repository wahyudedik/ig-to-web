...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 mb-6">
            <form method="GET" action="<?php echo e(route('admin.sarpras.kategori.index')); ?>" class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.sarpras.kategori.destroy', $k)); ?>"
                                            class="inline"
