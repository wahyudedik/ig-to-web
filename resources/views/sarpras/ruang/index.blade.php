<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('sarpras.ruang.create') }}" class="btn btn-primary">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 mb-6">
            <form method="GET" action="{{ route('sarpras.ruang.index') }}" class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                    ...
                    <tbody>
                        @forelse($ruangs as $index => $r)
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('sarpras.ruang.show', $r) }}"
                                        ...
                                        <a href="{{ route('sarpras.ruang.edit', $r) }}"
                                        ...
                                        <form method="POST" action="{{ route('sarpras.ruang.destroy', $r) }}"
                                            class="inline"
