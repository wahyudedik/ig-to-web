    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('sarpras.maintenance.edit', $maintenance) }}" class="btn btn-secondary">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="space-y-3">
                            <a href="{{ route('sarpras.maintenance.edit', $maintenance) }}"
                            ...
                            <form method="POST" action="{{ route('sarpras.maintenance.destroy', $maintenance) }}"
