    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('sarpras.kategori.edit', $kategori) }}" class="btn btn-secondary">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-6">
                        ...
                        @if ($kategori->barang->count() > 6)
                            <div class="mt-4 text-center">
                                <a href="{{ route('sarpras.barang.index', ['kategori' => $kategori->id]) }}"
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('sarpras.kategori.edit', $kategori) }}"
                        ...
                        <a href="{{ route('sarpras.barang.create', ['kategori' => $kategori->id]) }}"
