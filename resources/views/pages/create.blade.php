                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div id="menu-settings" class="space-y-4" style="display: none;">
                                        <div>
                                            <label for="menu_title" class="block text-sm font-medium text-gray-700 mb-1">Menu
                                                Title</label>
                                        ...
                                        <div>
                                            <label for="menu_position"
                                                class="block text-sm font-medium text-gray-700 mb-1">Menu Position</label>
                                        ...
                                        <div>
                                            <label for="menu_icon" class="block text-sm font-medium text-gray-700 mb-1">Menu
                                                Icon</label>
                                        ...
                                        <div>
                                            <label for="menu_url" class="block text-sm font-medium text-gray-700 mb-1">Custom
                                                URL</label>
