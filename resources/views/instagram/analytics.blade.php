    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-slate-600 mt-1">Analisis performa dan engagement Instagram sekolah</p>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 text-right">
            <span class="text-sm text-gray-500">
                ...
                Terakhir diperbarui: <span id="lastUpdated">{{ $analytics['last_updated']->format('d M Y H:i') }}</span>
            </span>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-slate-600">Total Comments</p>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-slate-600">Engagement Rate</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <h3 class="text-lg font-semibold text-slate-900 mb-4">Posts by Day of Week</h3>
                <canvas id="postsByDayChart" width="400" height="200"></canvas>
            </div>

            <!-- Engagement Chart -->
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <h3 class="text-lg font-semibold text-slate-900 mb-4">Engagement Metrics</h3>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 mb-8">
            <h3 class="text-lg font-semibold text-slate-900 mb-4">Top Performing Posts</h3>
            <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="text-center p-4 bg-slate-50 rounded-lg">
                    ...
                    <div class="text-sm text-slate-600">Media Count</div>
                </div>
                <div class="text-center p-4 bg-slate-50 rounded-lg">
                    <div class="text-2xl font-bold text-slate-900">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('refreshAnalytics').addEventListener('click', function() {
                    ...
                    fetch('/instagram/analytics/refresh')
                        ...
                        .finally(() => {
                            btn.disabled = false;
                            text.innerHTML = '<i class="fas fa-sync-alt mr-2"></i>Refresh Data';
                        });
                });
            });
        </script>
