                ...
                <form method="POST" action="{{ route('superadmin.users.update', $user) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="user_type" name="user_type" required
                            ...
                            <option value="guru"
                                {{ old('user_type', $user->user_type) === 'guru' ? 'selected' : '' }}>Guru</option>
                            <option value="siswa"
                                {{ old('user_type', $user->user_type) === 'siswa' ? 'selected' : '' }}>Siswa</option>
                            <option value="sarpras"
                                {{ old('user_type', $user->user_type) === 'sarpras' ? 'selected' : '' }}>Sarpras
                            </option>
                        </select>
                        @error('user_type')
                            <p class="form-error">{{ $message }}</p>
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        <a href="{{ route('superadmin.users.show', $user) }}" class="btn btn-secondary">Cancel</a>
