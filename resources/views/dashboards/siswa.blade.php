            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Anda login sebagai <span
                            class="font-semibold text-blue-600 dark:text-blue-400">Siswa</span></p>
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <span
                                class="px-2 py-1 text-xs font-semibold text-yellow-800 bg-yellow-100 rounded-full">Sedang
                                Dikerjakan</span>
                        </div>
                    </div>
                </div>
