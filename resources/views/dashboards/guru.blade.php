<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Guru Dashboard</h1>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-slate-600">Anda login sebagai <span class="font-semibold text-green-600">Guru</span>
                    </p>
                </div>
            </div>
        </div>
