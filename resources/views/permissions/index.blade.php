    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-slate-600 mt-1">Kelola permissions dan akses sistem</p>
            </div>
                    ...
                    <form method="GET" action="{{ route('admin.permissions.index') }}" class="flex flex-wrap gap-4">
                        ...
                        <div class="min-w-48">
                            ...
                            <select name="sort_by"
                                ...
                                <option value="module" {{ request('sort_by') == 'module' ? 'selected' : '' }}>Module
                                </option>
                                <option value="action" {{ request('sort_by') == 'action' ? 'selected' : '' }}>Action
                                </option>
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="text-slate-500">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-slate-900">No permissions found
                                            </h3>
