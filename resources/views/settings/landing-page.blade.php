                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="headmaster_name" name="headmaster_name"
                                value="{{ cache('site_setting_headmaster_name', 'Khoiruddinul Qoyyum,S.S.,M.Pd') }}"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder="Khoiruddinul Qoyyum,S.S.,M.Pd">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="headmaster_description" name="headmaster_description" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder="Sebagai kepala madrasah yang berpengalaman, kami berkomitmen untuk memberikan pendidikan terbaik...">{{ cache('site_setting_headmaster_description', 'Sebagai kepala madrasah yang berpengalaman, kami berkomitmen untuk memberikan pendidikan terbaik bagi para siswa dengan mengintegrasikan nilai-nilai keislaman dan pengetahuan modern.') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="headmaster_vision" name="headmaster_vision" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder="Visi kami adalah menciptakan generasi yang unggul dalam akademik...">{{ cache('site_setting_headmaster_vision', 'Visi kami adalah menciptakan generasi yang unggul dalam akademik, berakhlak mulia, dan siap menghadapi tantangan masa depan dengan bekal ilmu pengetahuan yang komprehensif.') }}</textarea>
                        </div>
