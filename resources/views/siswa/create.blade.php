                            ...
                            <div class="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="alamat_ortu" id="alamat_ortu" rows="2"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('alamat_ortu') border-red-500 @enderror">{{ old('alamat_ortu') }}</textarea>
                                    @error('alamat_ortu')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
