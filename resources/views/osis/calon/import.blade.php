<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Import Data Calon OSIS</h1>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl border border-slate-200 p-8">
            ...
            <!-- Instructions -->
            <div class="mb-8">
                <h3 class="text-lg font-semibold text-slate-900 mb-4">Panduan Import Data Calon OSIS</h3>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <ol class="list-decimal list-inside space-y-1">
                                ...
                                <li>Isi data calon sesuai format template</li>
                ...
                <div class="bg-slate-50 rounded-lg p-4">
                    ...
                    <div class="text-sm text-slate-600">
                        ...
                        <ul class="list-disc list-inside space-y-1 ml-4">
                            <li><strong>nama_ketua</strong> - Nama lengkap ketua calon (wajib)</li>
                            <li><strong>nama_wakil</strong> - Nama lengkap wakil calon (opsional)</li>
                            <li><strong>jenis_kelamin</strong> - L atau P (opsional)</li>
                            <li><strong>visi_misi</strong> - Visi dan misi calon (opsional)</li>
                            <li><strong>jenis_pencalonan</strong> - Ketua, Wakil, atau Pasangan (opsional)</li>
                            <li><strong>status_aktif</strong> - 1 (Aktif) atau 0 (Tidak Aktif) (opsional)</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <label for="skip_duplicates" class="ml-2 text-sm text-slate-700">
                                Skip data duplikat (berdasarkan nama ketua dan wakil)
                            </label>
                        </div>
                        <div class="flex items-center">
